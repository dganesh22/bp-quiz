...
function Login(props) {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            await app.auth().signInWithEmailAndPassword(user.email, user.pass)
                .then(res => {
                    toast.success(`Hi, ${res.user}, Login Successful.`)
                    navigate('/')
                ...
                <div className="col-lg-6 col-md-6 offset-lg-3 offset-md-3">
                    <div className="card">
                        <div className="card-header bg-secondary">
                            <h3 className="text-center text-light card-title">Sign In</h3>
                        </div>
                            ...
                            <form autoComplete="off" onSubmit={submitHandler} >
                                ...
                                <div className="form-group mt-2">
                                    ...
                                    <span className={'float-end'}>
                                        <strong>Already Registered?
                                            <NavLink to={`/signUp`} className="btn btn-link">Sign Up Here</NavLink> </strong>
                                    </span>
                                </div>
                            </form>
                        </div>
